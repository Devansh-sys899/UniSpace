...
const Hero = () => {
    return (
        <div className="max-w-screen lg:h-[110vh] overflow-hidden lg:py-10 lg:px-8 grid lg:grid-cols-2 md:grid-cols-1 md:h-[200vh] md:pr-20 justify-center gap-10 bg-surface_light">
            <div className=' flex flex-col mt-20 gap-4'>
                ...
                <div className='flex gap-6'>
                    <button onClick={() => navigate('/sign-in')} className='bg-primary text-white font-semibold px-4 py-2 rounded-lg'>Start Free trial</button>
